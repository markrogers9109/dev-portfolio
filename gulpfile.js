...
gulp.task('less', function () {
  gulp.src([
      './less/styles.less' //main entry point for styles. All other sheets should be included here.
    ])
    .pipe(plumber())
    .pipe(less())
    .pipe(autoprefixer())
...
gulp.task('serve', ['scripts', 'js-deps', 'css-deps', 'templates', 'less', 'copy-img', 'copy-index', 'favicon', 'copy-views', 'copy-fonts', 'watch'], function () {
  nodemon({
    script: 'server.js',
    ext: 'js html',
    ignore: ['node_modules']
